...
for w,f in enumerate(files):
    if(str(f) not in str(pngs)):
        ...
        for i,e in enumerate(Elem):
            ...
            polygon = ((Nodal[index1,0], Nodal[index1,1]),(Nodal[index2,0],Nodal[index2,1]), (Nodal[index3,0], Nodal[index3,1]),(Nodal[index4,0], Nodal[index4,1]),(Nodal[index1,0], Nodal[index1,1]))
            ymean = (Nodal[index1,1] + Nodal[index2,1] + Nodal[index3,1] + Nodal[index4,1])/4
            xmean = (Nodal[index1,0] + Nodal[index2,0] + Nodal[index3,0] + Nodal[index4,0])/4
            ...
            if(Nodal[index2,1] < -2930 and xmean > -10 and xmean < 100):
                ax.add_patch(patch)
        ...
        ax.text(80,-2970,"[min max] = " + str(np.round(dd[w])))
        #plt.plot()
        #plt.gca().invert_yaxis()
